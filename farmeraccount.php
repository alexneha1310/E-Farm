...
header('location:login.php');
	...
	if(isset($_POST['update']))
	{
		...
		$phone=$_POST['phone'];
		$adress=$_POST['adress'];
		$query=mysqli_query($con,"update register set fname='$fname',phone='$phone',adress='$adress' where loginid='".$_SESSION['fid']."'");
		if($query)
		{
...
include 'connection.php';
$rs = mysqli_query($con,"SELECT * FROM login WHERE status='1' and type='buyer' " );
...
<?php
$query=mysqli_query($con,"select * from register where loginid='".$_SESSION['fid']."'");
...
<div class="form-group">
					    ...
					    <input type="text" class="form-control unicase-form-control text-input" value="<?php echo $row['fname'];?>" id="name" name="fname" required="required">
					  </div>
			 ...
			 <input type="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" value="<?php echo $row['email'];?>" readonly>
					  ...
					  <div class="form-group">
					    ...
					    <input type="text" class="form-control unicase-form-control text-input" id="contactno" name="phone" required="required" value="<?php echo $row['phone'];?>"  maxlength="10">
					  </div>
					  <div class="form-group">
					    <label class="info-title" for="">Address <span>*</span></label>
					    <input type="text" class="form-control unicase-form-control text-input" id="contactno" name="adress" required="required" value="<?php echo $row['adress'];?>"  maxlength="10">
					  </div>
