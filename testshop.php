...
<body>
	...
	<div class="w3l_header_right">
        ...
        $name=$_POST['search'];
        $query="SELECT tbl_products.*,farmer_product.* from tbl_products,farmer_product where tbl_products.pro_id=farmer_product.pro_id and tbl_products.product_name='$name'";
...
<div class="row product-categorie-box">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade show active" id="grid-view">
                                    <div class="row">
                                    <?php  
                                    $result = mysqli_query($con,"SELECT tbl_products.*,farmer_product.* from tbl_products,farmer_product where tbl_products.pro_id=farmer_product.pro_id and tbl_products.product_name='$name'");
