	        ...
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
	            ...
	            <div class="col-md-12 ftco-animate text-center">
	              <h1 class="mb-2">Your Product Our Market</h1>
	              <h2 class="subheading mb-4">kindly fill the details of your farm inorder to sell the products on our site </h2>
	              <p><a href="farmdetail.php" class="btn btn-primary">ADD DETAILS</a></p>
	            </div>
