...
<body class="fix-header">
    <?php include 'head.php'; ?>
                        ...
                        <div class="card card-outline-primary">
                            ...
                            <div class="card-body">
                                 <form class="form-horizontal" role="form" method="post" action="a.php" enctype="multipart/form-data">
                                    <div class="form-body">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="farm_name" class="form-control" placeholder="">
                                                   </div>
                                            </div>
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    <label class="control-label">Upload_ID</label>
                                                    <input type="file" name="idproof"   class="form-control form-control-danger" placeholder="">
                                                    </div>
                                            </div>
                                        </div>
                                        <!--/row-->
